...
def gen_noisy_parabolic_data(a, b, c, xVals, file_name):
    yVals = []
    for x in xVals:
        theoretical_val = a*x**2 + b*x + c
        yVals.append(theoretical_val
                     + random.gauss(0, 35))  # adds Gaussian noise (mu=0, sd=1) to each point
    f = open(file_name, 'w')
    f.write('x        y\n')
...
# generate data
random.seed(0)
gen_noisy_parabolic_data(a, b, c, xVals,
                         'Dataset 1.txt')

gen_noisy_parabolic_data(a, b, c, xVals,
                         'Dataset 2.txt')

xVals1, yVals1 = get_data('Dataset 1.txt')
models1 = gen_fits(xVals1, yVals1, degrees)
test_fits(models1, degrees, xVals1, yVals1,
          'DataSet 1.txt')

pylab.figure()
xVals2, yVals2 = get_data('Dataset 2.txt')
models2 = gen_fits(xVals2, yVals2, degrees)
test_fits(models2, degrees, xVals2, yVals2,
          'DataSet 2.txt')

pylab.figure()
test_fits(models1, degrees, xVals2, yVals2,
          'DataSet 2/Model 1')
pylab.figure()
test_fits(models2, degrees, xVals1, yVals1,
          'DataSet 1/Model 2')
